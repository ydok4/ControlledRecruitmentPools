MixuAgentArtSetResources = {
	emp_wizard_death = {
		ArtSetIds = {
 			"wh2_main_art_set_emp_wizard_death_1", "wh2_main_art_set_emp_wizard_death_2", "wh2_main_art_set_emp_wizard_death_3", "wh2_main_art_set_emp_wizard_death_4", "wh2_main_art_set_emp_wizard_death_5",
		},
